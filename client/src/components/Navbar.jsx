  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
        ...
        {/* Desktop Menu (Contact included here now) */}
...
>
  ...
  <span className="px-4 py-2 rounded-full bg-black text-white">FREE</span>
</Link>
...
>
  <span className="px-5 py-2 text-black">Post Property</span>
  <span className="px-4 py-2 bg-black text-white rounded-full">FREE</span>
</Link>
